...
async def create_email_account(
    ...
    account = EmailAccount(
        ...
        imap_mark_as_read=data.imap_mark_as_read,
        imap_sync_days=data.imap_sync_days,
        imap_unseen_only=data.imap_unseen_only,
        imap_fetch_limit=data.imap_fetch_limit,
