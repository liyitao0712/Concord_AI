    ...
    <Card className="p-4 space-y-2">
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        ...
        <span className="flex items-center gap-2">
          {email.email_account_name && (
            <span className="truncate max-w-[100px]">{email.email_account_name}</span>
          )}
      ...
      <div className="flex gap-2 pt-1 border-t">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => onAiAnalyze(email.id)}
          className="flex-1 text-green-600 hover:text-green-900 h-8 text-xs"
        >
          AI分析
        </Button>
        <Button
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-4">
          ...
          <div className="flex gap-3">
            <select
              ...
              className="flex-1 md:flex-none px-3 py-2 border border-input rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            >
      ...
      {isMobile ? (
        ...
        <div className="space-y-3">
          {loading ? (
            ...
            <div className="py-8 text-center text-muted-foreground">暂无邮件记录</div>
          ) : (
            emails.map((email) => (
              <EmailCard
                key={email.id}
                ...
                onWorkType={handleWorkTypeAnalyze}
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between pt-2">
              <span className="text-xs text-muted-foreground">{page}/{totalPages} 页，共 {total} 封</span>
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto max-w-[95vw] md:max-w-3xl">
          ...
          {loadingDetail ? (
            ...
            <div className="space-y-6">
              ...
              {/* 操作按钮 */}
              <div className="flex flex-col-reverse md:flex-row justify-end gap-2 md:gap-3 pt-4 border-t">
                <Button
                  variant="outline"
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto max-w-[95vw] md:max-w-3xl">
          ...
          {aiAnalyzing ? (
            ...
            <div className="space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              {/* 元数据 */}
              <div className="text-xs text-muted-foreground flex flex-col md:flex-row md:justify-between gap-1 pt-2 border-t">
