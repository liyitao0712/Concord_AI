  ...
  return (
    <div className="space-y-6">
      ...
      {message && message.type === 'error' && (
        <ErrorAlert message={message.text} onRetry={loadModels} />
      )}
                        ...
                        >
                          ...
                          {model.total_requests > 0 && (
                            <div className="mb-3 flex items-center space-x-4 text-xs text-muted-foreground">
                              ...
                              {model.last_used_at && (
                                <span>最后使用: {formatDateTime(model.last_used_at)}</span>
                              )}
                            </div>
                          )}
      ...
      >
        ...
        <FormFooter
          ...
          submitText="创建模型"
          loading={creating}
          disabled={!createFormData.model_id || !createFormData.provider || !createFormData.model_name}
          type="button"
        />
      </FormDialog>
    </div>
