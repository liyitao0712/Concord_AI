    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          {/* SMTP 配置 */}
          <FormSection title="SMTP 发件配置" collapsible={false}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>服务器地址 *</Label>
                <Input
          ...
          {/* IMAP 配置 */}
          <FormSection title="IMAP 收件配置（可选）" collapsible={false}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>服务器地址</Label>
                <Input
          ...
          <FormFooter
            ...
            type="button"
            loading={saving}
            disabled={!formData.name || !formData.smtp_host || !formData.smtp_user || (!editingAccount && !formData.smtp_password)}
          />
        </div>
      </FormDialog>
      ...
      <FormDialog
        open={showTestModal}
        onOpenChange={(open) => !open && setShowTestModal(false)}
        title="连接测试结果"
        size="sm"
      >
        {testing ? (
